  ...
  return (
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        title="Sukolilo Camp"
        subtitle="Surabaya, Jawa Timur"
        peopleJoined="50+ Bergabung" />
        <CampSite
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        <h2 className="regular-24 md:regular-32 2xl:regular-64 text-white">
          <strong>Kamu mau</strong> ngecamp di surabaya?
        </h2>
        <p className="regular-14 xl:regular-16 mt-5 text-white">
          Tidak mungkin kamu dapat kesempatan untuk ngecamp di Surabaya.
        </p>
        <Image
        src="/quote.svg"
        alt="camp-2"
